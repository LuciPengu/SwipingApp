...
const sampleTickets: Ticket[] = [
  {
    ...
    description: "My Dell laptop screen flickers every few seconds when I connect it to the docking station. Started happening after the Windows update last week.",
    videoUrl: null,
    thumbnailUrl: null,
    priority: "high",
    status: "open",
  ...
  },
  {
    ...
    description: "I keep getting disconnected from the VPN during video calls. This is really affecting my work with remote clients.",
    videoUrl: null,
    thumbnailUrl: null,
    priority: "critical",
    status: "open",
  ...
  },
  {
    ...
    description: "I'm getting permission denied when trying to open the Marketing team folder. I had access yesterday.",
    videoUrl: null,
    thumbnailUrl: null,
    priority: "medium",
    status: "open",
  ...
  },
  {
    ...
    description: "Microsoft Outlook crashes immediately after I try to open it. I've tried restarting my computer multiple times.",
    videoUrl: null,
    thumbnailUrl: null,
    priority: "high",
    status: "open",
  ...
  },
  {
    ...
    description: "The office printer on 3rd floor isn't appearing in my printer list anymore. Other colleagues can see it fine.",
    videoUrl: null,
    thumbnailUrl: null,
    priority: "low",
    status: "open",
...
const leaderboardUsers: User[] = [
  ...
  {
    id: "agent-4",
    username: "jordan_help",
    password: "demo",
    displayName: "Jordan Help",
    avatarUrl: null,
    role: "agent",
    streak: 2,
    coins: 320,
